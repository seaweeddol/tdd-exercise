...
describe 'Blackjack Score' do
  ...
  it 'raises an ArgumentError for invalid cards' do
    ...
    expect{blackjack_score([54, 2, 5, 'King'])}.must_raise ArgumentError
  end

  it 'raises an ArgumentError for scores over 21' do
    expect{blackjack_score(['King', 6, 8, 3])}.must_raise ArgumentError
    expect{blackjack_score([10, 8, 'Ace', 'Queen'])}.must_raise ArgumentError
    expect{blackjack_score([3, 'Ace', 'Jack'])}.must_raise ArgumentError
  end
